...
function validateform(ev){
    if(regex1.test(input1.value)&& regex3.test(input3.value)&& regex4.test(input2.value)){
        var d = new Date()
...
/////////3 regexp
//function userinfo(){
//     var regex1 = /[a-zA-Z]{3,15}$/g
//     do{
//         var name2 =input1.value
      
//     }while(regex1.test(name2)==false)

   
   
//     var regex3 = /^(01)(0|1|2|5)[0-9]{8}$/
//     do{
//         var phoneNum=input3.value
//     }while(regex3.test(phoneNum)==false)
   
    
//     var regex4 = /^[a-zA-Z]{3,20}[0-9]+[$ & #]*(@)(gmail|yahoo|outlook|hotmail)(.com)$/i
//     do{
//         var email=input2.value
//     }while(regex4.test(email)==false)
// //}
//})
